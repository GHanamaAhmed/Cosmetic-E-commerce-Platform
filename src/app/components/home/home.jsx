...
export default memo(function Home() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="flex flex-col bg-caderSection relative items-center gap-3 rounded-xl w-[98%] pt-28 md:pt-28 lg:pt-36 md:flex-row-reverse md:justify-around lg:px-28">
